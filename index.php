        ...
        <div class="container px-5">
            ...
            <div class="row">
                <div id="carouselExampleCaptions" class="carousel game-slider" data-bs-ride="false">
                    <div class="carousel-inner game-slider__img">
                        <a href="./widget/detail.php?id=m77" class="slide carousel-item active">
                        ...
                        <a href="./widget/detail.php?id=m2" class="slide carousel-item">
                        ...
                        <a href="./widget/detail.php?id=m66" class="slide carousel-item">
                        ...
                        <a href="./widget/detail.php?id=m19" class="slide carousel-item">
                        ...
                        <a href="./widget/detail.php?id=m47" class="slide carousel-item">
                        ...
                        <a href="./widget/detail.php?id=m76" class="slide carousel-item">
            ...
            <div class="row">
                <div class="free-table">
                    ...
                    <div class="row">
                        <?php
                            $freeGames = mysqli_query($conn, "SELECT * FROM listgame WHERE price = 0 and tag !='upcoming' ORDER BY RAND() LIMIT 4");
                            if ($row = mysqli_fetch_array($freeGames)) {
                                do {
                                    ...
                                    echo '
                                        <div class="col-3">
                                            <a href="./widget/detail.php?id='.$gameid.'" class="game-card card mb-3">
                ...
                <div class="games-table">
                    <div class="col-4 games-table__column">
                        ...
                        <ul class="games-table__list">
                            <?php
                                $gameSeller = mysqli_query($conn, "SELECT * FROM listgame WHERE tag='topsellers' ORDER BY price ASC LIMIT 5");
                                    ...
                                    do {
                                        ...
                                        echo '
                                            <li class="games-table__item">
                                                <a href="./widget/detail.php?id='.$gameid.'" class="list-item games-table__link">
                    ...
                    <div class="col-4 games-table__column">
                        ...
                        <ul class="games-table__list">
                            <?php
                                mysqli_query($conn, "SET NAMES 'utf8'");
                                $mostPlayed = mysqli_query($conn, "SELECT * FROM listgame WHERE tag='mostplayed' ORDER BY price ASC LIMIT 5");
                    ...
                    <div class="col-4 games-table__column">
                        ...
                        <ul class="games-table__list">
                            <?php
                                mysqli_query($conn, "SET NAMES 'utf8'");
                                $gameUpcoming = mysqli_query($conn, "SELECT * FROM listgame WHERE tag='upcoming' ORDER BY price ASC LIMIT 5");
            ...
            <div class="row more">
                <div class="col-7 more__img">
                    <a href="./widget/search-page/searchpage.php" class="more__link"></a>
                </div>
                <div class="col-5 more__about">
                    <a href="./widget/search-page/searchpage.php" class="more__title">Explore Our Catalog</a>
                    <p class="more__desc">Browse by genre, features, price, and more to find your next favorite game.</p>
                    <a href="./widget/search-page/searchpage.php" class="btn btn-light more__btn">LEARN MORE</a>
                </div>
            </div>
        </div>
    </div>
